...
const String Master_category = "master_category";
const String Food_lic = "food_lic";
const String Gst_file = "gst_file";
const String Address_proof = "address_proof";
const String Logo = "logo";
const String Bank_pass = "bank_pass";
const String Pro_pic = "pro_pic";
