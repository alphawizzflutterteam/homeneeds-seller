...
Future<void> saveUserDetail({
  ...
  waitList.add(prefs.setString(Gender, gender!));
  waitList.add(prefs.setString(Master_category, masterCID!));
  waitList.add(prefs.setString(Food_lic, foodLic!));

  waitList.add(prefs.setString(Gst_file, gstFile!));
  waitList.add(prefs.setString(Address_proof, addressProf!));
  waitList.add(prefs.setString(Logo, logo!));
  waitList.add(prefs.setString(Bank_pass, bankPass!));
  waitList.add(prefs.setString(Pro_pic, proPic!));
