...
const Color primary =Color(0xFF138F51);
const Color secondary = Color(0xff767680);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xFF138F51);
const Color grad2Color = Color(0xFF138F51);
//const Color lightWhite2 = Color(0xffEEF2F3);

//const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xFF138F51);
